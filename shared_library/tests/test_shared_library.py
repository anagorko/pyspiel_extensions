...
# Attempt to import the custom shared library. If it fails, all tests will be skipped.
try:
    from pyspiel_extensions import shared_library
except ImportError as e:
    pytest.skip(f"Could not import the custom game library: {e}", allow_module_level=True)
